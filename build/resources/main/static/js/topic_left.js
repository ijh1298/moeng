...
const elementCategory1 = elementLeft.querySelector("#category1");
const elementTopic1 = elementLeft.querySelector("#topic1");
const elementCategory2 = elementLeft.querySelector("#category2");
const elementTopic2 = elementLeft.querySelector("#topic2");

function regenerate(event) {
  let randomCategoryObject = tcList[Math.floor(tcList.length * Math.random())];
  let randomTopicList = randomCategoryObject.topic;
  let randomTopic = randomTopicList[Math.floor(randomTopicList.length * Math.random())];
  elementCategory1.innerText = "\nCategory: " + randomCategoryObject.category;
  elementTopic1.innerText = randomTopic + "\n\n\n\n";
  randomCategoryObject = tcList[Math.floor(tcList.length * Math.random())];
  randomTopicList = randomCategoryObject.topic;
  randomTopic = randomTopicList[Math.floor(randomTopicList.length * Math.random())];
  elementCategory2.innerText = "Category: " + randomCategoryObject.category;
  elementTopic2.innerText = randomTopic;
}
regenerate();